...
=
\prod_{j=1}^{784}
\operatorname{Bernoulli}(x_j;\sigma(a_j(z))),
$$
...
![Langevin posterior smoke test](figures/langevin_posterior_smoke_test.png)<br>
**Figure 4: Langevin posterior smoke test**
...
=
\mathbb{E}_{p_{\theta^{\mathrm{old}}}(z \mid x)}\!\left[
\log p_\theta(x,z)
\right].
$$
...
3. Run Langevin dynamics using the current decoder to sample from $p_{\theta^{\mathrm{old}}}(z \mid x)$.
...
![EM M-step NLL curve](figures/em_m_step_nll_curve.png)<br>
**Figure 5: EM M-step NLL curve**

![EM validation reconstruction curve](figures/em_validation_reconstruction_curve.png)<br>
**Figure 6: EM validation reconstruction curve**
...
![VAE reconstructions](figures/vae_reconstructions.png)<br>
**Figure 7: VAE reconstruction**

The approximate EM reconstructions are also digit-like and visually similar to the original images.

![EM reconstructions](figures/em_reconstructions.png)<br>
**Figure 8: EM reconstruction**
...
</div>![VAE prior samples](figures/vae_prior_samples.png)</div>
**Figure 9: VAE prior samples**

</div>![EM prior samples](figures/em_prior_samples.png)</div>
...
![VAE vs EM reconstruction comparison](figures/vae_em_reconstruction_comparison.png)<br>
**Figure 11: VAE vs EM reconstruction comparison**

![VAE vs EM likelihood comparison](figures/vae_em_likelihood_comparison.png)<br>
**Figure 12: VAE vs EM likelihood comparisons**

### 7.3 Latent t-SNE Visualizations

The VAE encoder means show class-dependent structure in the latent space.

![VAE encoder mean t-SNE](figures/vae_encoder_mean_tsne.png)<br>
**Figure 13: VAE encoder mean t-SNE**
...
![EM encoder mean t-SNE](figures/em_encoder_mean_tsne.png)<br>
**Figure 14: EM encoder mean t-SNE**
...
![EM Langevin posterior t-SNE](figures/em_langevin_posterior_tsne.png)<br>
**Figure 15: EM Langevin posterior t-SNE**
